          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            {[
              { 
                ...
                links: language === "es" 
                  ? [{ text: "Instalación residencial", href: "/residential-installation" }, { text: "Instalación empresarial", href: "/business-installation" }, { text: "Baterías", href: "/services#service-battery" }, { text: "Autoconsumo", href: "/services#service-group-consumption" }, { text: "Mantenimiento", href: "/services#service-maintenance" }]
                  : [{ text: "Residential installation", href: "/residential-installation" }, { text: "Business installation", href: "/business-installation" }, { text: "Batteries", href: "/services#service-battery" }, { text: "Self-consumption", href: "/services#service-group-consumption" }, { text: "Maintenance", href: "/services#service-maintenance" }]
              },
